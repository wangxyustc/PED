...
class DiscreteActionEnv(object):
    ...
    def step(self, actions):
        ...
        obs, rews, dones, infos, avail_actions, paths = results
        return np.stack(obs), np.stack(rews), np.stack(dones), infos, avail_actions, paths

    def reset(self):
        obs, avail_actions = self.env.reset()
        return np.stack(obs), avail_actions
